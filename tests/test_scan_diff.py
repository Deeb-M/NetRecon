...
class ScanDiffTests(unittest.TestCase):
    ...
    def test_protocol_outer_whitespace_does_not_change_port_identity(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="192.0.2.10",
    ...
    def test_state_outer_whitespace_does_not_change_open_port_exposure(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="192.0.2.10",
    ...
    def test_whitespace_only_product_and_version_match_missing_metadata(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(80, "tcp", "open", "http", product=None, version=None),),
            ),),
        )
        after = Scan(
            source="after.xml",
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(80, "tcp", "open", "http", product="   ", version="\t"),),
            ),),
        )
    ...
    def test_service_case_and_outer_whitespace_do_not_change_exposure(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="192.0.2.10",
    ...
    def test_host_address_outer_whitespace_does_not_change_exposure_identity(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="192.0.2.10",
    ...
    def test_hostname_case_does_not_change_exposure_identity(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
    ...
    def test_hostname_case_and_outer_whitespace_do_not_change_exposure_identity(self) -> None:
        before = Scan(
            source="before.xml",
            hosts=(Host(
                address="Server.Example.COM",
