...
class AnalysisDiffTests(unittest.TestCase):
    ...
    def test_hostname_case_and_outer_whitespace_keep_new_finding_comparison_active(self) -> None:
        new_finding = Finding(
    ...
    def test_nse_script_id_outer_whitespace_matches_evidence_source(self) -> None:
        finding = Finding(
            finding_id="finding.nse",
            category="test",
            host="192.0.2.10",
            port=80,
            protocol="tcp",
    ...
    def test_nse_evidence_source_case_matches_script_id(self) -> None:
        finding = Finding(
            finding_id="finding.nse",
            category="test",
            host="192.0.2.10",
    ...
    def test_nse_evidence_source_outer_whitespace_matches_script_id(self) -> None:
        finding = Finding(
            finding_id="finding.nse",
            category="test",
            host="192.0.2.10",
    ...
    def test_service_detection_evidence_source_case_and_whitespace_are_normalized(self) -> None:
        finding = Finding(
    ...
    def test_service_application_evidence_source_case_and_whitespace_are_normalized(self) -> None:
        finding = Finding(
    ...
    def test_application_cpe_case_and_whitespace_do_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="finding.application",
            category="test",
            host="192.0.2.10",
    ...
    def test_service_platform_evidence_source_case_and_whitespace_are_normalized(self) -> None:
        finding = Finding(
            finding_id="finding.platform",
            category="test",
            host="192.0.2.10",
    ...
    def test_whitespace_only_os_type_does_not_count_as_platform_evidence(self) -> None:
        finding = Finding(
            finding_id="finding.platform",
            category="test",
            host="192.0.2.10",
        ...
        before_scan = Scan(
            ...
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(22, "tcp", "open", "ssh", os_type="   "),),
            ),),
        )
        after_scan = Scan(
            source="after.xml",
    ...
    def test_whitespace_only_cpe_does_not_count_as_platform_evidence(self) -> None:
        finding = Finding(
            finding_id="finding.platform",
            category="test",
            host="192.0.2.10",
        ...
        before_scan = Scan(
            ...
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(22, "tcp", "open", "ssh", cpes=("   ",)),),
            ),),
        )
        after_scan = Scan(
            source="after.xml",
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(22, "tcp", "open", "ssh", cpes=("cpe:/o:canonical:ubuntu_linux:24.04",)),),
            ),),
        )
    ...
    def test_whitespace_only_cpe_does_not_count_as_application_evidence(self) -> None:
        finding = Finding(
            finding_id="finding.application",
            category="test",
            host="192.0.2.10",
        ...
        before_scan = Scan(
            ...
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(80, "tcp", "open", "http", cpes=("   ",)),),
            ),),
        )
        after_scan = Scan(
            source="after.xml",
    ...
    def test_whitespace_only_service_does_not_count_as_detection_evidence(self) -> None:
        finding = Finding(
            finding_id="finding.service",
            category="test",
            host="192.0.2.10",
    ...
    def test_blank_nse_script_id_does_not_count_as_observed_evidence(self) -> None:
        finding = Finding(
            finding_id="finding.nse",
            category="test",
            host="192.0.2.10",
        ...
        after_scan = Scan(
            ...
            hosts=(Host(
                ...
                ports=(Port(
                    ...
                    "open",
                    "http",
                    scripts=(ScriptResult(script_id="http-title", output="Apache"),),
                ),),
            ),),
        )
    ...
    def test_nse_script_id_case_and_whitespace_after_prefix_are_normalized(self) -> None:
        finding = Finding(
            finding_id="finding.nse",
            category="test",
            host="192.0.2.10",
    ...
    def test_host_level_nse_script_id_case_and_whitespace_are_normalized(self) -> None:
        finding = Finding(
            ...
            evidence="evidence",
            recommendation="review",
            evidence_source=" NSE: HOST-SCRIPT ",
        )
        before_scan = Scan(
            source="before.xml",
            hosts=(Host(
    ...
    def test_ssh_algorithm_section_case_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_algorithm_section_whitespace_before_colon_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_algorithm_section_count_suffix_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_algorithm_order_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_duplicate_ssh_algorithm_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_real_ssh_algorithm_change_is_still_detected(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_removed_ssh_algorithm_is_detected_as_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_algorithm_moved_between_sections_is_detected_as_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_section_order_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_blank_lines_in_ssh_algorithm_output_do_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_algorithm_outer_whitespace_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_unknown_ssh_section_does_not_leak_lines_into_previous_known_section(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_known_ssh_section_after_unknown_section_is_still_parsed(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_unknown_ssh_section_with_count_does_not_leak_into_previous_section(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_ssh_section_numeric_count_is_metadata_not_algorithm(self) -> None:
        finding = Finding(
            finding_id="ssh.algorithms.inventory",
            category="test",
            host="192.0.2.10",
    ...
    def test_detected_service_case_does_not_create_unknown_product_semantic_change(self) -> None:
        finding = Finding(
    ...
    def test_real_detected_service_change_updates_unknown_product_semantic_state(self) -> None:
        finding = Finding(
            finding_id="service.product.unknown",
            category="test",
            host="192.0.2.10",
    ...
    def test_detected_service_appearing_changes_unknown_product_semantic_state(self) -> None:
        finding = Finding(
            finding_id="service.product.unknown",
            category="test",
            host="192.0.2.10",
    ...
    def test_real_platform_os_type_change_is_detected_semantically(self) -> None:
        finding = Finding(
        ...
        after_scan = Scan(
            ...
            hosts=(Host(
                address="192.0.2.10",
                status="up",
                ports=(Port(22, "tcp", "open", "ssh", os_type="Windows"),),
            ),),
        )
    ...
    def test_platform_os_cpe_order_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="host.platform.context",
            category="test",
            host="192.0.2.10",
    ...
    def test_duplicate_platform_os_cpe_does_not_create_semantic_change(self) -> None:
        finding = Finding(
            finding_id="host.platform.context",
            category="test",
            host="192.0.2.10",
    ...
    def test_platform_os_type_addition_across_ports_is_semantic_change(self) -> None:
        finding = Finding(
            finding_id="host.platform.context",
            category="context",
            host="192.0.2.10",
